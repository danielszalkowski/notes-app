...
class Property extends Model
{
    ...
    protected $fillable = [
        'intern_reference', 'title', 'street', 'number', 'zip_code',
        'is_active', 'is_sell', 'is_rent', 'sell_price', 'rental_price',
        'built_m2', 'office_id', 'property_type_id', 'user_id', 
        'secondary_user_id', 'neighborhood_id', 'district_id', 
        'municipality_id', 'region_id', 'location_id'
    ];
    ...
    public function secondaryUser() { return $this->belongsTo(User::class, 'secondary_user_id'); }
